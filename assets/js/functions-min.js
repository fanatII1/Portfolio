    ...
    l(Y, I, {
        handler: function De(t) {
            ...
            e & Pt && 0 === t.button && (this.pressed = !0),
                e & Ot && 1 !== t.which && (e = Rt),
                this.pressed &&
                (e & Rt && (this.pressed = !1), this.callback(this.manager, e, {
                    pointers: [t],
                    changedPointers: [t],
                    pointerType: _t,
                    srcEvent: t
        ...
        l(k, I, {
            handler: function _e(t) {
                ...
                s & Pt && (0 === t.button || o) ? 0 > a && (e.push(t), (a = e.length - 1)) : s & (Rt | Mt) && (i = !0),
                    0 > a ||
                    ((e[a] = t), this.callback(this.manager, s, {
                        pointers: e,
                        changedPointers: [t],
                        pointerType: r,
                        srcEvent: t
        ...
        l(it, et, {
            ...
            directionTest: function (t) {
                ...
                return (
                    s & e.direction ||
                    (e.direction & qt ?
                        ((s = 0 === r ? zt : 0 > r ? Nt : Xt), (i = r != this.pX), (n = Math.abs(t.deltaX))) :
                        ((s = 0 === o ? zt : 0 > o ? Yt : kt), (i = o != this.pY), (n = Math.abs(t.deltaY)))),
                    (t.direction = s),
